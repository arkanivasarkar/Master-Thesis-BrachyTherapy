...
nifti1 = nib.load(r"C:\Users\arkaniva\Downloads\pp.nii")
grid_mask_file = nib.load(r"C:\Users\arkaniva\Downloads\Segmentation-Segment_1-label.nii")

nii_data = nifti1.get_fdata()

grid_mask = np.squeeze(grid_mask_file.get_fdata()).T
plt.imshow(grid_mask,cmap='binary')
plt.show()
